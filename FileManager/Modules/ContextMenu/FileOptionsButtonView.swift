...
struct FileOptionsButtonView: View {
    ...
    var body: some View {
        ...
        .destinationPopover(viewModule: viewModel)
        .conflictAlert(viewModule: viewModel)
...
extension View {
    func conflictAlert(viewModule: FileOptionsButtonViewModel) -> some View {
    ...
    func destinationPopover(viewModule: FileOptionsButtonViewModel) -> some View {
